...
EasyMDE.prototype.render = function (el) {
    ...
    // 我们还需要一个 DOM 容器来包裹预览内容
    var sideBySideWrapper = document.createElement('div');
    sideBySideWrapper.classList.add('side-by-side-wrapper');
    easyMDEContainer.appendChild(sideBySideWrapper);
    sideBySideWrapper.appendChild(cmWrapper);
